      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between bg-opacity-90">
          ...
          <ul className="flex justify-center space-x-4">
            ...
            <li>
              <div className="relative" ref={dropdownRef}>
                ...
                {showDropdown && (
                  <div className="absolute top-full left-1/2 transform -translate-x-1/2 bg-gray-800 text-gray-300 py-2 rounded w-full max-w-7xl">
        ...
        <div className="md:hidden flex-grow text-center">
          <div className="relative">
            ...
            {showMenu && (
              <div className="absolute top-full left-0 bg-gray-800 text-gray-300 py-2 rounded w-full max-w-7xl">
                <Link
                  href="/"
                  className="block px-4 py-2 hover:bg-gray-700 w-full"
