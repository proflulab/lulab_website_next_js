...
export default function App() {
  ...
  const [windowWidth, setWindowWidth] = useState(0); // 初始化为0
  ...
  const showMenuButton = windowWidth <= 640; // 根据窗口宽度确定是否显示菜单按钮
          ...
          <>
            ...
            <Dropdown>
              ...
              >
                <DropdownItem
                  key="autoscaling"
                  description="Dedicated to creating a virtual language environment for children to enhance their foreign language listening and speaking skills."
                ...
                <DropdownItem
                  key="usage_metrics"
                  description="Strives to enhance children's computer skills and digital literacy through games and practical experience."
                ...
                <DropdownItem
                  ...
                  description="This is a cradle for a group of children's project collisions."
                  startContent={icons.flash}
                >
                  <Link href="/DigitalMicroprojectsClub">
                    <a style={{ color: "white" }}>Digital Microprojects Club</a>
                  </Link>
                </DropdownItem>
                <DropdownItem
                  key="99_uptime"
                  description="Mastering advanced digital technology through project-driven learning."
                ...
                <DropdownItem
                  key="supreme_support"
                  description='Using the most advanced artificial intelligence technology to create "Exclusive ChatGPT of Lulab"'
                ...
                <DropdownItem
                  key="supreme_support"
                  description="Take you to master cutting-edge practical digital marketing methodology."
                  startContent={icons.user}
                >
                ...
                <DropdownItem
                  key="supreme_support"
                  description="The leadership club, originating from Tsinghua University and led by Professor Lu Xiangqian, nurtures innovation and leadership"
                  startContent={icons.user}
                >
