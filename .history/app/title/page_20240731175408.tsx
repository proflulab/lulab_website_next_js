...
const App: React.FC = () => {
  ...
  return (
    <React.StrictMode>
      <NextUIProvider>
        <main className="bg-light-green text-gray-800 min-h-screen">
          <Navbar
            onMenuOpenChange={setIsMenuOpen}
            className="bg-light-green text-gray-800 shadow-md"
          >
            <NavbarContent>
              {showMenuButton && (
            ...
            <NavbarContent className="sm:flex gap-4" justify="center">
              {!showMenuButton && (
                <>
                  ...
                  <Dropdown className="bg-light-green text-gray-800">
                    <NavbarItem>
                      <DropdownTrigger>
                        <Button
                          disableRipple
                    ...
                    <DropdownMenu className="bg-light-green text-gray-800">
                      <DropdownItem
                        as={Link}
                        href="/MetaverseClub"
            ...
            {showMenuButton && isMenuOpen && (
              <NavbarMenu
                className="bg-light-green text-gray-800 shadow-md"
                style={{ backgroundColor: "rgba(144, 238, 144, 0.8)" }} // Light green
              >
