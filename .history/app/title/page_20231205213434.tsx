            ...
            <li>
              <div className="relative" ref={menuRef}>
                ...
                {(showMenu || window.innerWidth > 600) && (
                  <div className={`absolute top-full left-0 bg-gray-800 text-gray-300 py-2 rounded w-${window.innerWidth > 600 ? '72' : 'full'}`}>
                    <a
                      href="#"
                      className="block px-4 py-2 hover:bg-gray-700"
                      onClick={toggleClubs}
              ...
              {(showClubs || window.innerWidth > 600) && (
                <div className={`absolute top-full left-72 bg-gray-800 text-gray-300 py-2 rounded w-${window.innerWidth > 600 ? '72' : 'full'}`}>
                  <a
                    className="block px-4 py-2 hover:bg-gray-700"
                    onClick={() => handleClubClick("/MetaverseClub")}
                  >
