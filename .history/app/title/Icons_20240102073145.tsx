...
export const Scale = ({
  ...
  return (
    <svg viewBox="0 0 24 24" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><defs><style>.cls-1{fill:none;stroke:#f93939;stroke-miterlimit:10;stroke-width:1.95px;}</style></defs><path className="cls-1" d="M16.89,6.14h3.9a2,2,0,0,1,2,2v7.82a2,2,0,0,1-2,1.95H14.93l-1.42-2.12a1.81,1.81,0,0,0-3,0L9.07,17.86H3.21a2,2,0,0,1-2-1.95V8.09a2,2,0,0,1,2-1.95H16.89Z"></path><circle class="cls-1" cx="6.14" cy="12" r="1.95"></circle><circle class="cls-1" cx="17.86" cy="12" r="1.95"></circle></g></svg>
  );
};
