        ...
        <div className="flex items-center flex-shrink-0 text-black mr-6">
          ...
          >
            ...
            <Image
              src="/logo.png"
              alt="Lu Lab"
              className="w-10 h-10 md:w-12 md:h-12" // 在大屏幕上设置较大的尺寸
              width={100}
              height={100}
            />
            <span className="ml-4 text-3xl lu-lab-text font-semibold md:text-2xl md:text-3xl lg:text-2xl xl:text-2xl">
              Lu Lab
            </span>
          </div>
        </div>
        ...
        <div className="md:hidden flex-grow ">
          <div className="relative">
            <button
              ...
              className="text-white text-3xl px-5 py-2 rounded font-semibold hover:text-black text-right"
            >
              <FaBars />
            </button>
                  ...
                  <div className="max-w-7xl mx-auto relative">
                    <ul className="flex flex-col items-center space-y-4">
                      <button
                        ...
                        className="text-white text-3xl px-5 py-2 rounded font-semibold hover:text-black absolute top-4 left-4"
                      >
                        <FaTimes />
                      </button>
                      <li>
                        ...
                        <div className="relative" ref={dropdownRef}>
                          ...
                          {showDropdown && (
                            <div className=" bg-opacity-75 text-white py-4">
                              <a
                                className="block px-4 py-2 hover:bg-gray-700 text-2xl"
                                onClick={() =>
