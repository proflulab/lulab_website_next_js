...
const Activity = ({ fill = "#9b14cc", size, height, width, ...props }: any) => {
  const svgStyle = {
    fillRule: "evenodd",
    clipRule: "evenodd",
    strokeLinejoin: "round",
  ...
  return (
    <svg
      ...
      width={width || "64px"}
      height={height || "64px"}
      viewBox="-320.7 -320.7 1710.40 1710.40"
      style={svgStyle}
      version="1.1"
      xmlSpace="preserve"
      xmlns="http://www.w3.org/2000/svg"
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        ></rect>
        <g>
          <path d="M434.469,693.912 ... (剩余的路径数据)"></path>
          <path d="M720.632,552.486c-0,-18.253 " style={pathStyle}></path>
        </g>
      </g>
    </svg>
  );
