        ...
        <div className="flex items-center flex-shrink-0 text-black mr-6">
          ...
          >
            ...
            <Image
              src="/logo.png"
              alt="Lu Lab"
              className="w-10 h-10 md:w-20 md:h-20" // 在大屏幕上设置较大的尺寸
              width={100}
              height={100}
            />
            <span className="ml-4 text-3xl lu-lab-text font-semibold md:text-2xl md:text-3xl lg:text-4xl xl:text-5xl">
              Lu Lab
            </span>
          </div>
        </div>
