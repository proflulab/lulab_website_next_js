...
const App: React.FC = () => {
  ...
  return (
    <React.StrictMode>
      <NextUIProvider>
        <main className="bg-lightGreen text-darkGreen min-h-screen">
          <Navbar
            onMenuOpenChange={setIsMenuOpen}
            className="bg-lightGreen text-darkGreen"
          >
            <NavbarContent>
              {showMenuButton && (
              ...
              <NavbarBrand>
                <Logo />
                <p className="font-bold text-darkGreen">Lu Lab</p>
              </NavbarBrand>
            </NavbarContent>
            ...
            <NavbarContent className="sm:flex gap-4" justify="center">
              {!showMenuButton && (
                <>
                  <NavbarItem>
                    <Link color="darkGreen" href="/">
                      Home
                    </Link>
                  </NavbarItem>
                  <Dropdown className="bg-lightGreen text-darkGreen">
                    <NavbarItem>
                      <DropdownTrigger>
                        <Button
                          disableRipple
                    ...
                    <DropdownMenu className="bg-lightGreen text-darkGreen">
                      <DropdownItem
                        as={Link}
                        href="/MetaverseClub"
                      ...
                      >
                        <a className="text-darkGreen">Metaverse Club</a>
                      </DropdownItem>
                      <DropdownItem
                        as={Link}
                      ...
                      >
                        <a className="text-darkGreen">Digital Literacy Club</a>
                      </DropdownItem>
                      <DropdownItem
                        as={Link}
                      ...
                      >
                        <a className="text-darkGreen">AI Club</a>
                      </DropdownItem>
                      <DropdownItem
                        as={Link}
                      ...
                      >
                        <a className="text-darkGreen">Digital Marketing Club</a>
                      </DropdownItem>
                      <DropdownItem
                        as={Link}
                        href="/LeadershipClub"
                      ...
                      >
                        <a className="text-darkGreen">Leadership Club</a>
                      </DropdownItem>
                    </DropdownMenu>
                  </Dropdown>
                  <NavbarItem>
                    <Link color="darkGreen" href="/Course">
                      Course
                    </Link>
                  </NavbarItem>
                  <NavbarItem>
                    <Link color="darkGreen" href="/About">
                      About
                    </Link>
                  </NavbarItem>
                </>
                    ...
                    {item === "Clubs" ? (
                      <>
                        <div className="flex items-center justify-between w-full ">
                          <Link className="w-full" color="darkGreen" size="lg">
                            {item}
                          </Link>
                          <Dropdown className="bg-lightGreen text-darkGreen">
                            <DropdownTrigger>
