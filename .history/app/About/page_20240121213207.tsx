      ...
      >
        ...
        <Box
          sx={{
            ...
            alignItems: "center",
            paddingLeft: "10px",
            flexDirection: { xs: "column", md: "row" }, // Adjust the direction based on screen size
          }}
        >
          ...
          <Grid
            sx={{
              ...
              fontSize: "16px",
              fontWeight: "400",
              marginLeft: { xs: "0px", md: "20px" }, // Adjust the margin based on screen size
              textAlign: { xs: "center", md: "left" }, // Adjust the text alignment based on screen size
              marginTop: { xs: "20px", md: "0" }, // Adjust the margin top based on screen size
            }}
          >
            <Typography
              sx={{
