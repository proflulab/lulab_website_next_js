        ...
        <ScrollAnimation>
          <Accordion sx={{ marginBottom: "20px" }}>
            <AccordionSummary
              ...
              id="panel1a-header"
            >
              <Typography variant="h6">Learn More About Lu Lab</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
                Here you can add detailed information about Lu Lab, its history,
                achievements, and other relevant details. This section can be
