    ...
    <>
      ...
      >
        ...
        {!isMobile && (
          ...
          >
            <div style={{ flex: "1", marginRight: "40px", marginLeft: "40px" }}>
            ...
            <div style={{ flex: "1", marginRight: "20px", marginLeft: "40px" }}>
              <Image src="/Edu.png" alt="" width={35} height={35} />
            ...
            <div style={{ flex: "1", marginLeft: "40px", marginRight: "40px" }}>
