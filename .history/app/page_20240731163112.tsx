      ...
      <div style={{ backgroundColor: "#e0f7e9" }}>
        <div
          style={{
            ...
            alignItems: "center",
            backgroundColor: "#fefae0", // Soft cream background
          }}
        >
          <div
            style={{
                ...
                <motion.div whileHover={{ scale: 1.05 }}>
                  <Card
                    sx={{
                      ...
                      boxShadow: 3,
                      borderRadius: "15px",
                      backgroundColor: "#fff5e1", // Vintage cream
                      border: "1px solid #A52A2A", // Vintage red
                    }}
                  >
                    <CardMedia
                      sx={{ height: 140 }}
                    ...
                    <CardContent>
                      <OverviewIcon
                        fontSize="large"
                        style={{ color: "#A52A2A", marginBottom: "10px" }} // Vintage red
                      />
