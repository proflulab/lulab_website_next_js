      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between bg-opacity-90">
        <div className="flex items-center flex-shrink-0 text-black mr-6">
          ...
          >
            ...
            <span className="ml-6 text-lg lu-lab-text">Lu Lab</span>
          </div>
        </div>
        ...
        <div className="flex-grow text-center">
          <ul className="flex justify-center space-x-4">
            <li>
              <a
                href="/"
                className="text-white hover:bg-gray-700 px-5 py-2 rounded font-semibold"
              >
                Home
              </a>
            </li>
            <li>
              <div className="relative">
                <a
                  href="#"
                  className="text-white hover:bg-gray-700 px-5 py-9 rounded font-semibold"
            ...
            <li>
              <a
                href="/About"
                className="text-white hover:bg-gray-700 px-3 py-2 rounded font-semibold"
              >
                About
              </a>
            </li>
