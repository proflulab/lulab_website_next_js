    ...
    <>
      ...
      <div
        style={{
          ...
          alignItems: "center",
          background: "linear-gradient(to right, #e0f2f1, #b9fbc0)", // 淡绿色渐变背景
          minHeight: "100vh",
          paddingBottom: "80px", // 空间留给页脚
        }}
      >
        <div
          style={{
            ...
            boxShadow: "0 4px 8px rgba(0,0,0,0.2)", // 轻微阴影效果

            border: "2px solid #e0f2f1", // 边框样式
          }}
        >
          <div
            style={{
