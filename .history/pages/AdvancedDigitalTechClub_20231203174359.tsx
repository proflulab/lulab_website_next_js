        ...
        <div style={{ position: "relative" }}>
          ...
          >
            <div style={{ margin: "20px ", fontSize: "36px" }}>
              <div>
                At the Advanced Digital Technology Club, we are committed to
                turning knowledge into action. Our approach is to learn skills
                by doing projects. Students begin their learning journey by
                attending meetings that encourage questions and discussion. With
                a solid foundation, let&apos;s do projects together and turn
                ideas into reality! Join us for a better future!
              </div>
              <div
                style={{
                  color: "black",
