          ...
          >
            <div style={{ margin: "20px ", fontSize: "36px" }}>
              <div>
                ...
                <br /> fundamental programming concepts, seamlessly integrating
                computer technology into their daily lives. This sets a solid
                foundation for them to become adept talents in the era of
