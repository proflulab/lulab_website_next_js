          ...
          >
            <div style={{ margin: "20px ", fontSize: "36px" }}>
              <div>
                ...
                <br />
                master the essential skills needed for project execution. This
                prepares children for further personal development as they
                aspire to excel in their future endeavors.
              </div>
              <div
                style={{
                  color: "black",
